...
import { Card, Row, Col, Table, TableColumn, Tooltip, Dialog, Pagination, Progress, Carousel, CarouselItem } from 'element-ui'
Vue.use(Form).use(FormItem).use(Input).use(Button).use(Carousel).use(CarouselItem)
